...
3) 课后服务
   ...
   - 北京地区的同学，如果需要，可以利用周六、周日非课程直播时段，到线下场地和老师面对面交流。不在北京的同学，如果需要类似的服务，可通过视频通话等方式提供。
...
1. 用智能手机或平板电脑横屏观看课程直播或者课程直播回放。
1. 观看直播时点击屏幕可隐藏评论区信息，亦可用手势放大画面。
1. 观看直播时，应积极参与老师发起的互动或按要求操作电脑。
1. 用智能手机或者平板电脑有选择地观看直播回放，并同时在电脑（宿主操作系统）上打开课件。点击课件页面中演示视频的链接，可在电脑上观看演示视频。此时，可在虚拟机上运行的 Ubuntu Linux 环境中对照演示视频进行实操练习。
1. 观看直播回放时，可选择章节播放自己感兴趣的内容。
