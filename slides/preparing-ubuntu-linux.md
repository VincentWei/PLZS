...
- 课程体系（续）
   4) 信奥初级班：本课程针对计划参加 NOI CSP-J 比赛的学生准备，要求已掌握信奥筑基班的课程内容。课程内容围绕四则运算表达式、JSON 解析器等综合练习进行，通过将 NOI 大纲（初级）中所列知识点融入解析器的开发加深学生对相关知识的理解和掌握。
   5) 信奥提高班：本课程针对计划参加 NOI CSP-S 比赛的学生准备，要求已掌握信奥初级班的课程内容。课程内容围绕正则表达式以及一个简单脚本语言的解释器开展，通过将 NOI 大纲（提高级）中所列知识点融入脚本语言的解释器加深学生对相关知识的理解和掌握。
   5) 程序员/信奥生的数学素养课：本课程针对学习信息科学的科技特长生及程序员开设，内容涉及初等数论、微积分基础、离散数学结构、编解码等，旨在提前补充信奥大纲规定的数学知识。
...
1. 推荐使用短视频应用的电脑版观看课程视频；若使用手机，请横屏观看。
1. 在虚拟机上运行的 Ubuntu Linux 环境虚拟机中，使用浏览器打开课件，并对照演示视频进行实操练习。
1. 若课程视频中包含课堂练习，请务必暂定视频的播放，尝试在给定的时间内完成课堂练习。
