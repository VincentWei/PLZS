...
- 对信息学感兴趣的九岁及以上学生（小学三年级或以上，数学基础好的可从二年级学起）。
- 计划参加“蓝桥杯”编程比赛或信息学奥林匹克竞赛的小学生。

课程特点：

- 独特内容：有机结合了数学和信息学的知识点
- 循序渐进：内容设置符合小学生的认知水平
- 寓教于乐：诸多趣味历史故事，培养学习兴趣
- 能力培养：强调算法思维，提升抽象思维和逻辑思维能力
- 效果保障：作业批改及单元测验，巩固学习效果

课程收获：

1. 掌握数论基础、实数和函数、组合数学、初等代数、欧式几何、图及图论等信息学的数学基础知识。
1. 掌握进制转换、算法的三种描述方法、基础数据结构、基础算法等信息学的核心基础知识。
1. 使用中文编程语言（可执行考鼎码）在浏览器中编写、调试和运行常见的算法程序。
1. 学完前四个单元之后，即可进入开始学些使用 Python 在 Linux 环境下编写正式的程序。

规格说明：

1. 【含基础课后服务】一年内不限次线上答疑和作业批改、单元测验等课后服务。
1. 【含十次一对一私教服务】除提供基础课后服务之外，包含十次一对一私教课后服务，每次一小时。
1. 【一对一私教服务】在购买了课程的前提下，可根据学习情况单独选购，每次一小时。
...
答：本课程提供三种课后服务：
   ...
   1. 含基础课后服务：一年内不限次线上答疑和作业批改、单元测验等课后服务。
   1. 含十次一对一私教服务：除提供基础课后服务之外，包含十次一对一私教课后服务，每次一小时。此项服务通过腾讯会议平台开展，由助教老师提供一对一作业点评及答疑等课后辅导，针对性强，私密性好；每次一个小时。购买后请联系班主任预约时间。
   1. 一对一私教服务：可根据学习情况单独购买。此项服务通过腾讯会议平台开展，由助教老师提供一对一作业点评及答疑等课后辅导，针对性强，私密性好；每次一个小时。购买后请联系班主任预约时间。

问：购买后如何上课?  
答：购课成功后，请按照发货短信中的内容做课前准备并开始学习。请家长或学生及时扫码加班主任的企业微信，如有疑问请及时联系班主任。

问：课程有效期多长?  
答：购买后，课程内容两年内有效；建议在两个学期内完成学习并及时提交作业给班主任老师，以便按正常节奏进入下个阶段的学习。
