...
1. 授课方式：
   - 零基础普及班为录播课，外加答疑直播。
   - 筑基班、AI实战班以、信奥初级班、信奥提高班均为直播课，外加作业点评及答疑直播。
   - 作业点评和答疑直播每周至少安排两场。
1. 学习周期：
...
1. 建议学习路线：
   - 零基础想学习全栈开发技术的学生：零基础普及班 -> 筑基班 -> AI 实战班
   - 零基础想参加信奥竞赛的学生： 零基础普及班 -> 筑基班 -> 信奥初级班 -> AI 实战班 -> 信奥提高班
   - 已学习 Python 的学生：信奥初级班 -> AI 实战班 -> 信奥提高班
   - 只对信奥竞赛感兴趣的学生：信奥初级班 -> 信奥提高班
...
| 信奥初级班    | Python, C++               | Linux, GCC, CMake, JSON, CSP-J                        |
| 信奥提高班    | Python, C++               | Linux, GCC, CMake, RegEx, CSP-P                       |
...
零基础普及班面向零基础但对编程有强烈兴趣的大中小学生（年龄在 10 到 18 周岁；小学五年级到大学一年级），学过一些编程课程的更好。
...
直接购买筑基班课程的，同时赠送零基础普及班课程；详情请联系客服或班主任。
...
直接购买本课程的，可优惠购买筑基班课程并获赠零基础普及版课程；详情请联系客服。
...
直接购买本课程的，可优惠购买筑基班课程并获赠零基础普及班课程；详情请联系客服。
